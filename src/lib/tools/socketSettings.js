...
export const newConnectionHandler = (newClient) => {                                                // <---- THIS IS THE SOCKET HANDLER
 ...
 newClient.on("upVote", async(socket)=>{                                                        //when a client emits an upVote event
 ...
 newClient.on("downVote", async(socket)=>{                                                     //when a client emits a downVote event
